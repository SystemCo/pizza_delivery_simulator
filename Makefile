...
all: objects/dcarter.o objects/log.o objects/timers.o \
	objects/image.o objects/animations.o asteroids 
...
objects/animations.o: animations.cpp shared.h dcarter.h
	g++ -c -o objects/animations.o animations.cpp

asteroids: asteroids.cpp objects/dcarter.o objects/log.o \
	objects/timers.o objects/image.o objects/animations.o
	g++ $(CFLAGS) asteroids.cpp objects/log.o objects/timers.o \
		objects/dcarter.o objects/image.o objects/animations.o libggfonts.a \
